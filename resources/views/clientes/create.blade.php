	...
	<body style="background-color: #041424; ">
		<form action='#' method="POST" style="margin-top: 10px;">
			...
			<table class="table table-light table-striped" style="text-align: center;">
				<th colspan="2"><h4>Nuevo Cliente</h4></th>
				<tr>
					<td class="input-group">
						...
						<input type="text" name="ape_cliente" id="ape_cliente" class="form-control"></td>
				</tr>
				<tr>		
					<td class="input-group">
						...
						<input type="text" name="dir_cliente" id="dir_cliente" class="form-control"></td>
				</tr>
				<tr>
					<td colspan="2">
